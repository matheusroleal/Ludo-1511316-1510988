...
public class Regras implements ObservadorIF {
     	...
     	if(JogadoresController.getJogadoresController().getJogadorTurno() == 0) {
    		...
    		if(j1.getPeao(j1.getNumPeao()).getCinco(1) == false){ //se cincoX for false quer dizer que o jogador ainda n tirou o numero 5 no dado para poder sair da casa inicial
				...
				if(movimento == 5) { //se movimento for 5, jogador pode colocar peca na casa de saida
					...
					if(Inicializador.getInicializador().getCaminho(novo_x1, novo_y1).o1 != null) {
						if(Inicializador.getInicializador().getCaminho(novo_x1, novo_y1).o1.getP1().a != Color.RED) {
    		...
    		if(j1.getPeao(j1.getNumPeao()).getC(1) == true){//quando c1 for true, quer dizer q o peao ja esta no tabuleiro e vai andar por ele
				...
				if(j1.getPeao(j1.getNumPeao()).getY(1) == true) {
					...
					//captura
					if(Inicializador.getInicializador().getCaminho(novo_x1, novo_y1).aux != null) {
						if(Inicializador.getInicializador().getCaminho(novo_x1, novo_y1).aux.getP1().a != Color.RED) {
			...
			if(Inicializador.getInicializador().getCaminho(novo_x1, novo_y1).o2 != null){
                ...
                Inicializador.getInicializador().getCaminho(novo_x2, novo_y2).o2.getP1().barreira = false;
    			Inicializador.getInicializador().getCaminho(novo_x2, novo_y2).o1.getP1().pode = false;
			...
			if(j2.getPeao(j2.getNumPeao()).getCinco(2) == false) {
				...
				if(movimento == 5) { 
					...
					if(Inicializador.getInicializador().getCaminho(novo_x2, novo_y2).o1 != null) {
						if(Inicializador.getInicializador().getCaminho(novo_x2, novo_y2).o1.getP1().a != Color.GREEN) {
			...
			if(j2.getPeao(j2.getNumPeao()).getC(2) == true) {
				...
				if(j2.getPeao(j2.getNumPeao()).getY(2) == true) {
					...
					if(Inicializador.getInicializador().getCaminho(novo_x2, novo_y2).aux != null) {
						if(Inicializador.getInicializador().getCaminho(novo_x2, novo_y2).aux.getP1().a != Color.GREEN) {
							if(Inicializador.getInicializador().getCaminho(novo_x2, novo_y2).aux.getP1().ExibeP() == Color.RED) {
			...
			if(j2.getNumPeao() == 0)
				Inicializador.getInicializador().vd1.setLocation(50*novo_y2, 50*novo_x2);
			else if(j2.getNumPeao() == 1)
				Inicializador.getInicializador().vd2.setLocation(50*novo_y2, 50*novo_x2);
			else if(j2.getNumPeao() == 2)
				Inicializador.getInicializador().vd3.setLocation(50*novo_y2, 50*novo_x2);
			else if(j2.getNumPeao() == 3)
				Inicializador.getInicializador().vd4.setLocation(50*novo_y2, 50*novo_x2);				

			
			if(Inicializador.getInicializador().getCaminho(novo_x2, novo_y2).o2 != null) {
                if(Inicializador.getInicializador().getCaminho(novo_x2, novo_y2).o1.getP1().a == Inicializador.getInicializador().getCaminho(novo_x2, novo_y2).o2.getP1().a) {
                    Inicializador.getInicializador().getCaminho(novo_x2, novo_y2).barreira = true;
                    Inicializador.getInicializador().getCaminho(novo_x2, novo_y2).o2.getP1().barreira = true;
                }
                else {
			...
			if(Inicializador.getInicializador().getCaminho(novo_x1, novo_y1).o2 != null){
                ...
                Inicializador.getInicializador().getCaminho(novo_x3, novo_y3).o2.getP1().barreira = false;
    			Inicializador.getInicializador().getCaminho(novo_x3, novo_y3).o1.getP1().pode = false;
			...
			if(j3.getPeao(j3.getNumPeao()).getCinco(3) == false) {
				...
				if(movimento == 5) { 
					...
					if(Inicializador.getInicializador().getCaminho(novo_x3, novo_y3).o1 != null) {
						if(Inicializador.getInicializador().getCaminho(novo_x3, novo_y3).o1.getP1().a != Color.YELLOW) {
	...
	//					if(Inicializador.getInicializador().getCaminho(novo_x3, novo_y3).o1.getP1().a != Color.YELLOW) {
			...
			if(j3.getNumPeao() == 0)
				Inicializador.getInicializador().am1.setLocation(50*novo_y3, 50*novo_x3);
			else if(j3.getNumPeao() == 1)
				Inicializador.getInicializador().am2.setLocation(50*novo_y3, 50*novo_x3);
			else if(j3.getNumPeao() == 2)
				Inicializador.getInicializador().am3.setLocation(50*novo_y3, 50*novo_x3);
			else if(j3.getNumPeao() == 3)
				Inicializador.getInicializador().am4.setLocation(50*novo_y3, 50*novo_x3);				
	
			if(Inicializador.getInicializador().getCaminho(novo_x3, novo_y3).o2 != null) {
				if(Inicializador.getInicializador().getCaminho(novo_x3, novo_y3).o1.getP1().a == Inicializador.getInicializador().getCaminho(novo_x3, novo_y3).o2.getP1().a) {
                    Inicializador.getInicializador().getCaminho(novo_x3, novo_y3).barreira = true;
                    Inicializador.getInicializador().getCaminho(novo_x3, novo_y3).o2.getP1().barreira = true;
                }
                else {
			...
			if(Inicializador.getInicializador().getCaminho(novo_x1, novo_y1).o2 != null){
                ...
                Inicializador.getInicializador().getCaminho(novo_x4, novo_y4).o2.getP1().barreira = false;
    			Inicializador.getInicializador().getCaminho(novo_x4, novo_y4).o1.getP1().pode = false;
			...
			if(j4.getPeao(j4.getNumPeao()).getCinco(4) == false) {
				...
				if(movimento == 5) { 
					...
					if(Inicializador.getInicializador().getCaminho(novo_x4, novo_y4).o1 != null) {
						if(Inicializador.getInicializador().getCaminho(novo_x4, novo_y4).o1.getP1().a != Color.BLUE) {
			...
			if(j4.getNumPeao() == 0)
				Inicializador.getInicializador().az1.setLocation(50*novo_y4, 50*novo_x4);
			else if(j4.getNumPeao() == 1)
				Inicializador.getInicializador().az2.setLocation(50*novo_y4, 50*novo_x4);
			else if(j4.getNumPeao() == 2)
				Inicializador.getInicializador().az3.setLocation(50*novo_y4, 50*novo_x4);
			else if(j4.getNumPeao() == 3)
				Inicializador.getInicializador().az4.setLocation(50*novo_y4, 50*novo_x4);				
		
			if(Inicializador.getInicializador().getCaminho(novo_x4, novo_y4).o2 != null) {
				if(Inicializador.getInicializador().getCaminho(novo_x4, novo_y4).o1.getP1().a == Inicializador.getInicializador().getCaminho(novo_x4, novo_y4).o2.getP1().a) {
                    Inicializador.getInicializador().getCaminho(novo_x4, novo_y4).barreira = true;
                    Inicializador.getInicializador().getCaminho(novo_x4, novo_y4).o2.getP1().barreira = true;
                }
                else {
